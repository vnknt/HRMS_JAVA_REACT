...
export default function horizontalCard(props) {
    ...
    return (
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-10">
            <div class="card-body">
              <a class="advert-job" href={`/job-adverts/detail/${props.titleUrl}` } >{props.job} </a>
              <p class="card-text">
                 {props.company}
              </p>
              ...
              <div class="card-text row">
                  <div class="col-9 ">
                    <div class="col-12" >
                    <small class="text-muted  advert-date">İlan Thi   : {Moment(props.creationDate).format('DD/MM/YYYY')}</small>
                    </div>
